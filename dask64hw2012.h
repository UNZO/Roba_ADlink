// ========================================================================
// 	     VERSIONE MODIFICATA PER VISUAL STUDIO 2012 
//  	ridotta alla sola versione Hardware con la ADLINK9112
// ========================================================================
...
#ifndef BOOLEAN9112 
  typedef short  BOOLEAN9112;  // modifica di vice
#endif 

#ifndef VOID
  typedef void  VOID;  // modifica di vice
#endif 
...
I16 __stdcall AI_AsyncCheck(U16 CardNumber, BOOLEAN9112 *Stopped, U32 *AccessCnt);

I16 __stdcall AI_AsyncClear(U16 CardNumber, U32 *AccessCnt);

I16 __stdcall AI_AsyncDblBufferHalfReady(U16 CardNumber, BOOLEAN9112 *HalfReady,   BOOLEAN9112 *StopFlag);

I16 __stdcall AI_AsyncDblBufferMode(U16 CardNumber, BOOLEAN9112 Enable);
...
I16 __stdcall AI_AsyncReTrigNextReady(U16 CardNumber, BOOLEAN9112 *Ready,   BOOLEAN9112 *StopFlag, U16 *RdyTrigCnt);

I16 __stdcall AI_ContReadChannel(U16 CardNumber, U16 Channel, U16 AdRange,    U16 *Buffer, U32 ReadCount, F64 SampleRate, U16 SyncMode);

I16 __stdcall AI_ContReadMultiChannels(U16 CardNumber, U16 NumChans,   U16 *Chans, U16 *AdRanges, U16 *Buffer, U32 ReadCount, F64 SampleRate,   U16 SyncMode);

I16 __stdcall AI_ContScanChannels(U16 CardNumber, U16 Channel, U16 AdRange,    U16 *Buffer, U32 ReadCount, F64 SampleRate, U16 SyncMode);

I16 __stdcall AI_ContReadChannelToFile(U16 CardNumber, U16 Channel,   U16 AdRange, U8 *FileName, U32 ReadCount, F64 SampleRate, U16 SyncMode);

I16 __stdcall AI_ContReadMultiChannelsToFile(U16 CardNumber, U16 NumChans,  U16 *Chans, U16 *AdRanges, U8 *FileName, U32 ReadCount, F64 SampleRate,  U16 SyncMode);

I16 __stdcall AI_ContScanChannelsToFile(U16 CardNumber, U16 Channel,  U16 AdRange, U8 *FileName, U32 ReadCount, F64 SampleRate, U16 SyncMode);

I16 __stdcall AI_ContStatus(U16 CardNumber, U16 *Status);

I16 __stdcall AI_ContBufferSetup(U16 CardNumber, void *Buffer, U32 ReadCount,  U16 *BufferId);
...
I16 __stdcall AO_6202_Config(U16 CardNumber, U16 ConfigCtrl, U16 TrigCtrl, \
    U32 ReTrgCnt, U32 DLY1Cnt, U32 DLY2Cnt, BOOLEAN9112 AutoResetBuf);
...
I16 __stdcall AO_AsyncCheck(U16 CardNumber, BOOLEAN9112 *Stopped, U32 *AccessCnt);

I16 __stdcall AO_AsyncClear(U16 CardNumber, U32 *AccessCnt, U16 stop_mode);

I16 __stdcall AO_AsyncDblBufferHalfReady(U16 CardNumber, BOOLEAN9112 *bHalfReady);

I16 __stdcall AO_AsyncDblBufferMode(U16 CardNumber, BOOLEAN9112 Enable);
...
I16 __stdcall DI_7300A_Config(U16 CardNumber, U16 PortWidth, U16 TrigSource, \
    U16 WaitStatus, U16 Terminator, U16 I_REQ_Pol, BOOLEAN9112 clear_fifo, \
    BOOLEAN9112 disable_di);

I16 __stdcall DI_7300B_Config(U16 CardNumber, U16 PortWidth, U16 TrigSource, \
    U16 WaitStatus, U16 Terminator, U16 I_Cntrl_Pol, BOOLEAN9112 clear_fifo, \
    BOOLEAN9112 disable_di);
...
I16 __stdcall DI_9222_Config(U16 CardNumber, U16 ConfigCtrl, U16 TrigCtrl, \
    U32 ReTriggerCnt, BOOLEAN9112 AutoResetBuf);

I16 __stdcall DI_9223_Config(U16 CardNumber, U16 ConfigCtrl, U16 TrigCtrl, \
    U32 ReTriggerCnt, BOOLEAN9112 AutoResetBuf);

I16 __stdcall DI_AsyncCheck(U16 CardNumber, BOOLEAN9112 *Stopped, U32 *AccessCnt);

I16 __stdcall DI_AsyncClear(U16 CardNumber, U32 *AccessCnt);

I16 __stdcall DI_AsyncDblBufferHalfReady(U16 CardNumber, BOOLEAN9112 *HalfReady);

I16 __stdcall DI_AsyncDblBufferHandled(U16 CardNumber);

I16 __stdcall DI_AsyncDblBufferMode(U16 CardNumber, BOOLEAN9112 Enable);
...
I16 __stdcall DI_AsyncMultiBufferNextReady(U16 CardNumber, BOOLEAN9112 *NextReady, \
    U16 *BufferId);

I16 __stdcall DI_AsyncReTrigNextReady(U16 CardNumber, BOOLEAN9112 *Ready, \
    BOOLEAN9112 *StopFlag, U16 *RdyTrigCnt);
...
I16 __stdcall DO_AsyncCheck(U16 CardNumber, BOOLEAN9112 *Stopped, U32 *AccessCnt);

I16 __stdcall DO_AsyncClear(U16 CardNumber, U32 *AccessCnt);

I16 __stdcall DO_AsyncMultiBufferNextReady(U16 CardNumber, BOOLEAN9112 *NextReady, \
    U16 *BufferId);
